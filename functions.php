...
function enregistrer_sidebar() {
    register_sidebar( array(
        'name' => __( 'Pied de page 1', '31w-mondir' ),
        'id' => 'pied-page-1',
        'description' => __( 'Une zone widget pour afficher des widgets dans le pied de page.', '31w-mondir' ),
    ...
    register_sidebar( array(
        'name' => __( 'Pied de page 2', '31w-mondir' ),
        'id' => 'pied-page-2',
        'description' => __( 'Une zone widget pour afficher des widgets dans le pied de page.', '31w-mondir' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
    ...
    register_sidebar( array(
        'name' => __( 'Pied de page 3', '31w-mondir' ),
        'id' => 'pied-page-3',
        'description' => __( 'Une zone widget pour afficher des widgets dans le pied de page.', '31w-mondir' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
